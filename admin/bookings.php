      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            ...
            <a class="item" href="travelclass.php">Traveling Classes</a>
...
<thead><tr><th>#Order Ref</th><th>Customer Name</th><th>Email</th><th>Class Reserved</th><th>Destination</th><th>#No Seats</th><th>Travel Date</th><th>Operation</th></tr></thead>
<tbody>
<?php
require("../dbengine/dbconnect.php");
...
{$order=$row['order_ref'];
echo("<tr><td>".$row['order_ref']."</td><td>".$row['fullname']."</td><td>".$row['EmailId']."</td><td>".$row['class_reserved']."</td><td>".$row['destination']."</td><td>".$row['seats_reserved']."</td><td>".$row['date_reserved']."</td><td><a class='ui tiny button orange' href='bookings.php?reject=$order'>Reject</a></td></tr>");
}		
}
else{
