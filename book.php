...
<!-- Banners -->
    ...
    <div class="ui text container" style="margin-top:3rem; margin-bottom:3rem;">
...
<script>
setTimeout(function(){document.getElementById("proceed").innerHTML="<a href='booking1.php' class='btn btn-outlined-primary' style='width:100%;'>Book Ticket</a>  "},3000);
</script>
