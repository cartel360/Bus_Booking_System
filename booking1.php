        ...
        <div id="dynamic">
          ...
          <div class="ui container text" id="contact-page" style="display:none">
            ...
            <form class="ui form attached fluid loading segment" onsubmit="return billing(this)">
              ...
              <input type="text" name="bus_id" id="bus_id" value="<?php echo $bus_id; ?>" placeholder="<?php echo $bus_id; ?>" hidden>
          ...
          <div class="ui container text" id="billing-page" style="display:none">
            ...
            <form class="ui form attached fluid loading segment" onsubmit="return confirmdetails(this)">
              ...
              <div class="field">
                <label style="color:green; height:6rem; font-size:25px; font-weight:bold;">MPESA <span style="color:green; font-weight:bold; font-size: 20px;"><span>via</span>Till NO. 5970127</span></label>
              </div>
