    ...
    <div class="row">
      <div class="col-md-2 col-sm-2">
        ...
        <div class="col-md-6 col-sm-5">
          ...
          if ($num_of_rows <= 0) {
          ?>
            <h3 class="text-center pt-5">No Available Bus on that Date <br>
              <small><a href="booking1.php" style="text-align:center">Reschedule your journey</a><small>
            </h3>
            <br>
            <h3 class="text-center pt-5">Other Available Buses</h3> <br>
              <?php
             
    
              $this__query = mysqli_query($con, "SELECT * FROM trains");
              while ($row_two = mysqli_fetch_array($this__query)) {
                $id = $row_two['id'];
                $name = $row_two['name'];
                ...
                if ($ava == 0) {
                  ...
                  $sql = "SELECT * FROM routes WHERE train_id = '$id'";
                  $re = mysqli_query($con, $sql);
